def display(file):
    ...
    for line in file:
        ...
        #to split the hero name and the year sperately.
        # The seperation occurs at ','.abs

        #Takig the first element of the split
        ...
        #list, anfd then append it to the list "heroes".
        heroes.append([hero, first_appearance])
